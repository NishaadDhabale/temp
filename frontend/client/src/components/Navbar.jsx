...
<h1 className="text-xl font-bold">Blue Carbon MRV</h1>
      ...
      <div className="hidden md:flex items-center space-x-6">
        ...
        <Link to="/block" className="hover:text-blue-200 transition-colors font-medium flex items-center space-x-1">
            <ListPlus className="w-4 h-4" />
            <span>Register Project</span>
        </Link>
        <Link to="/admin" className="hover:text-blue-200 transition-colors font-medium flex items-center space-x-1">
